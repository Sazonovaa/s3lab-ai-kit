...
- **По умолчанию: `standard`** — стандартный UX/UI разбор и состояния компонентов.
- Альтернативы: `light` — короткие чеклисты и a11y-review; `heavy` — сложные multi-step user flows.
