...
## Recommended models
Preferred:
- `claude-4.6-sonnet-medium-thinking` — стандартная подготовка test plan и анализ падений.

Alternatives:
- `gpt-5.5-medium` — короткие smoke планы.
- `gpt-5.3-codex-high-fast` — генерация Playwright-каркаса по AC.
