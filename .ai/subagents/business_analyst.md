...
## Recommended models
Preferred:
- `claude-4.6-sonnet-medium-thinking` — стандартная работа с PRD и AC.

Alternatives:
- `gpt-5.5-medium` — быстрые короткие постановки.
- `claude-opus-4-7-thinking-xhigh` — большие сложные сценарии с многими стейкхолдерами.
