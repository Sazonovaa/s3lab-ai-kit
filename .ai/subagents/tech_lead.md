...
- **По умолчанию: `heavy`** — широкие кросс-доменные решения и спорные trade-off.
- Альтернативы: `standard` — обычная оркестрация и делегирование; `light` — короткая маршрутизация.
